...
export const ABUSE_WINDOW_SECONDS = Number(
  process.env.ABUSE_WINDOW_SECONDS ?? 600,
); // 10 minutes
export const TEMP_BLOCK_SECONDS = Number(
  process.env.ABUSE_TEMP_BLOCK_SECONDS ?? 3600,
); // 1 hour
