...
Lo que Dostoievski entendió, y lo que vuelve más aterrador *El jugador* ahora que la primera vez que lo leí, es que la ruleta es solo una máquina entre muchas. La forma sobrevive mucho después de que el casino cambia de disfraz. Apostar, hacer scroll, volver a escribirle a la persona equivocada, revisar si llegó un mensaje que no va a llegar, regresar a la misma herida para ver si cambió mientras no mirabas: todo eso obedece a la misma gramática. El siguiente momento me salvará. El siguiente número. El siguiente giro. La siguiente respuesta. La siguiente humillación disfrazada de revelación.
